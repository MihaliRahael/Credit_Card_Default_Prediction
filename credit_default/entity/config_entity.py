...
class ModelTrainerConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.base_accuracy: float = training_pipeline.BASE_ACCURACY
...
class ModelEvaluationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_evaluation_file_path = os.path.join(self.model_evaluation_dir,training_pipeline.MODEL_EVALUATION_FILE_NAME_KEY)
...
class ModelPusherConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        os.mkdir(self.model_pusher_dir)
